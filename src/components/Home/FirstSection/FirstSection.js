...
import ParaAnimation from "@/components/ParaAnimation/ParaAnimation";

const FirstSection = () => {
  return (
    <div className="grid grid-cols-[58%,40%] gap-2 px-28 mt-[65px] py-16 relative h-[470px]">
      ...
      <div className="flex flex-col justify-center w-full gap-4">
        <h1 className="text-4xl text-[#444444] leading-[45px]">
